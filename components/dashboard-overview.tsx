...
const initialDashboard = { stats: [] as DashboardStat[], latestContents: [] as AdminRow[], latestApplications: [] as AdminRow[] };
...
export function DashboardOverview() {
  ...
  return (
    <>
      <PageTitle title="控制台" description="认证机构号、内容审核、前台菜单、评论、报告和操作日志的第一阶段正式版本概览。" />
      ...
      <section className="mt-6 rounded-md border border-line bg-white p-5 shadow-soft">
        <h2 className="text-lg font-semibold text-ink">第一阶段业务边界</h2>
